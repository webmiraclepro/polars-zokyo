...
contract PrimaryPool is DSMath {
    ...
    constructor(
        ...
        require(
            ...
            "Collateralization address should not be null"
        );
    ...
    function buy(uint256 payment) public {
        ...
        uint256 tokensAmount = wdiv(payment, getBWprice().mul(2));
        require(tokensAmount >= _minBlackAndWhiteBuy, "Buy amount is too low");
