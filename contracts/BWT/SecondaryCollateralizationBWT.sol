...
contract SecondaryCollateralization is ISecondaryCollateralization {
    ...
    constructor (
        ...
        require (bwtAddress != address(0), "BWT token address should not be null");
    ...
    external override onlyPool {
        require (destination != address(0), "Destination address shouold not be null");
