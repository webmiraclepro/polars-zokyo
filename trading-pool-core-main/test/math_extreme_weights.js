...
contract('BPool', async (accounts) => {
    ...
    before(async () => {
        ...
        await pool.setLiquidityProvidersFee(toWei(String(swapFee)));
    });
    ...
    describe('Extreme weights', () => {
        ...
        it('joinPool', async () => {
            currentPoolBalance = '1';
            await pool.finalize();

            // // Call function
            const poolAmountOut = '0.01';
        ...
        it('exitPool', async () => {
            ...
            const poolAmountIn = 1 / (1 - exitFee) / 100;
